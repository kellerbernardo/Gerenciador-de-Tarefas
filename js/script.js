...
function formValidate(taskName, taskDate, taskPriority, taskStatus) {
    ...
    if (taskDate === '') {
        alert('Digite um valor de data');
        result = false;
    }

    if (taskPriority === '') {
        alert('Digite a prioridade da tarefa');
        result = false;
    }

    if (taskStatus === '') {
        alert('Digite o status da tarefa');
        result = false;
    }
    return result;
}
...
function formatInputs(taskDate, taskPriority, taskStatus) {
    this.taskDate       = taskDate.split('-').reverse().join('/'); // Explode cada if, separando e invertendo...
